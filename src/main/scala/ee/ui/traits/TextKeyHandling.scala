...
import ee.ui.application.OperatingSystem._
import ee.ui.application.ClipBoard
import ee.ui.application.ImplicitSystemClipBoard
...
trait TextKeyHandlers extends ImplicitSystemClipBoard { self: TextInputLike =>

  lazy val systemClipBoard = implicitly[ClipBoard]
