...
"""
    ...
    val propertyGroups = (1 to 22).map { i =>
      ...
      val types = generateTypes(i)
      val propertyNames = generateStrings(i, "p")
      val onChangedNotify = generateStrings(i, "    p", " onChanged propertyChanged()", "\n")
